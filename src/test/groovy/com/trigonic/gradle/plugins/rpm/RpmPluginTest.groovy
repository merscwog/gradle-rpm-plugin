...
class RpmPluginTest {
    ...
    @Test
    public void differentUsersBetweenCopySpecsMethodAssignment() {
        Project project = ProjectBuilder.builder().build()
    ...
    @Test
    public void differentGroupsBetweenCopySpecsMethodAssignment() {
        Project project = ProjectBuilder.builder().build()
    ...
    @Test
    public void differentPermissionsBetweenCopySpecsMethodAssignment() {
        Project project = ProjectBuilder.builder().build()
